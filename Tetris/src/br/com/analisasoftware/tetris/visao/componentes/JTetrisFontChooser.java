/*
 *Diálogo de seleção de fontes para atributos de componentes do TetrisIDE
 *Criada a partir do código-gonte JFontChooser acessado em:
 *http://www.java2s.com/Code/Java/Swing-Components/TheJFontChooserclassisaswingcomponentforfontselection.htm
...
public class JTetrisFontChooser extends JComponent
{
    // class variables
    /**
     ...
     **/
    public JTetrisFontChooser(String[] fontSizeStrings)
    {
